...
export const KEYMAP = Object.freeze([
  ...
  planned('B', 'loupe.toggle', ['Z'], 'always', 'Loupe on / off'),
  planned('B', 'snap.toggle', ['N'], 'always', 'Snapping on / off'),
  ...
  planned('B', 'pen.undo', ['Z'], 'pen', 'Undo (pin, move, snap, delete, close, rename, mirror)', { mods: { mod: true } }),
  planned('B', 'pen.redo', ['Z'], 'pen', 'Redo', { mods: { mod: true, shift: true } }),
  planned('B', 'pen.nudge', ['ArrowLeft', 'ArrowRight', 'ArrowUp', 'ArrowDown'], 'pen', 'Nudge the selected point 1 px along the skin (Shift: 10 px)', { needsSelection: true, shiftOptional: true }),
  planned('B', 'pen.snap-level', ['Shift'], 'pen', 'Level snap while pinning: same height as the previous anchor', { hold: true }),
  planned('B', 'pen.snap-mirror', ['Alt'], 'pen', 'Mirror snap while pinning: mirror of the selected line\'s last anchor', { hold: true }),
  b('pen.reset-handles', ['R'], 'pen', 'Re-centre the control points of the selected segment (whole line if none)'),
  planned('B', 'pen.mirror-line', ['M'], 'pen', 'Mirror the selected line to the other side'),
