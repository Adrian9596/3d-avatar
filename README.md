...
- [`AUTHORING_UX_PLAN.md`](AUTHORING_UX_PLAN.md) — orbit-while-drafting, the grazing guard and the shared keyboard map (Phase A, built); a snapping pen, landmark placement that records how well a point was placed, and template drafts from landmarks (Phases B–D, planned).
